...
\begin{multicols}{2}	
	...
	\begin{figure}
		\centering
		\includegraphics[width=\linewidth]{img/generate}
	\end{figure}
\end{multicols}
\end{frame}
...
\begin{figure}
	\centering
	\includegraphics[width=\linewidth]{img/label}
\end{figure}
\end{frame}
...
\begin{figure}
	\centering
	\includegraphics[width=\linewidth]{img/cat_label}
\end{figure}
\end{frame}
...
\begin{itemize}
	...
	\begin{figure}
		\centering
		\includegraphics[width=\linewidth]{img/exchange}
	\end{figure}
	...
	\begin{figure}
		\centering
		\includegraphics[width=\linewidth]{img/exchange_label}
	\end{figure}
...
\begin{itemize}
	\item Open up a new do-file. Window -> Do-file Editor -> New Do-file Editor. Or click the shortcut highlighted below:
		\begin{figure}
			\centering
			\includegraphics[width=\linewidth]{img/dofilewindow1}
		\end{figure}
	...
	\begin{figure}
		\centering
		\includegraphics[width=\linewidth]{img/dofilewindow2}
	\end{figure}
\end{itemize}
\end{frame}
...
\begin{figure}
	\centering
	\includegraphics[width=\linewidth]{img/macro1}
\end{figure}
\begin{itemize}
...
\begin{figure}
	\centering
	\includegraphics[width=\linewidth]{img/macro2}
\end{figure}
\begin{itemize}
...
\begin{figure}
	\centering
	\includegraphics[width=\linewidth]{img/paths1}
\end{figure}
...
\begin{figure}
	\centering
	\includegraphics[width=\linewidth]{img/paths2}
\end{figure}
\end{frame}

\begin{frame}{Lab Task 5}
\begin{itemize}
	\item Open the do-file you created in the previous task and create a global to the folder where you have been saving your work. Call the global folder\_Lab1
	\item To check what is stored in your global, type this in the command window and hit enter:
		\begin{itemize}
			\item display "\$folder\_Lab1“
		\end{itemize}
	\item Update the use and save commands in your do-file with the global you created. Like this:
		\begin{figure}
			\centering
			\includegraphics[width=\linewidth]{img/pathslab}
		\end{figure}
	\item Now, run your do-file again and test that it works
\end{itemize}
\end{frame}
	...
	\item Copy the code generated when using the menu to your do-file. Run again. Did you get an error?
		\begin{itemize}
			\item Since you already saved the data set under the new name, Stata warns you that there already is a file with that name. We want to overwrite it as each time we make an update to the instructions, we want the final data to reflect that. We therefore need to add a comma and the word replace. Like this:
				\begin{figure}
					\centering
					\includegraphics[width=\linewidth]{img/savedata}
				\end{figure}
		\end{itemize}
