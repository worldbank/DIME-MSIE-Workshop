...
\begin{frame}{Installing IPA's HFC Framework}
	...
	\begin{itemize}
		\item \url{https://github.com/PovertyAction/high-frequency-checks} and click the \texttt{Clone or download} button and select \texttt{Download ZIP}.
...
\begin{frame}{IPA's HFC: Add more tests}
	...
	\begin{itemize}
		...
		\item In \texttt{11. outliers}, add all the \texttt{inc\_01},\texttt{inc\_02},...,\texttt{inc\_17} variables. See that both variable and multiplier is green so both are required. Set all multipliers to 3.
	\end{itemize}
\end{frame}
