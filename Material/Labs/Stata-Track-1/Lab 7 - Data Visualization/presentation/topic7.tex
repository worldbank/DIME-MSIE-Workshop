...
\begin{frame}[fragile]{Task 1: Histogram}
	\begin{itemize}
		...
		\begin{itemize}
			...
			\item Make the y-axis depict frequencies
			\item Change the width of the bins
			\item Change the titles for the graph and the x-axis
		\end{itemize}
...
\begin{frame}[fragile]{Task 3: Scatter plots}
	\begin{itemize}
		\item Let's make a scatter plot for the variables \texttt{ag\_18\_x\_16\_1} and \texttt{ag\_16\_x\_16\_1}
		...
		\item Separate out scatter points by treatment arm
		\item Save the final graph created
	\end{itemize}
\end{frame}
