...
\begin{figure*}[h]
{\setstretch{0.7}
\VerbatimInput[frame=lines,numbers=left,label=cleaning.do]{../DataWork/Lab2/cleaning.do}}
\end{figure*}
...
\begin{figure*}[h]
{\setstretch{0.7}
\VerbatimInput[frame=lines,numbers=left,label=analysis.do]{../DataWork/Lab2/analysis.do}}
\end{figure*}
