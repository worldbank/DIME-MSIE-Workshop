...
\section{Part 4: Pair up and share a secure folder with someone else (If time permits)}
...
\begin{enumerate}
	...
	\item Access your partner's encrypted file by mounting it in VeraCrypt using the password your partner shared with you.
\end{enumerate}
